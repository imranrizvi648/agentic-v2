      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center mt-5 mb-2 w-full overflow-hidden">
          <div className="relative w-full">
            ...
            {/* ── DESKTOP ONLY (lg+): absolute labels over the canvas ── */}
            {/* Untouched — same positions as original, looks perfect on laptop */}
            <span className="hidden lg:inline absolute bottom-[18%] left-[24%] text-[9px] xl:text-[11px] font-bold text-gray-500 uppercase tracking-tighter whitespace-nowrap pointer-events-none z-10">
              ©2026 AgenticSense Design Studio.
            </span>
            <span className="hidden lg:inline absolute bottom-[18%] left-[56%] -translate-x-1/2 text-[9px] xl:text-[11px] font-bold uppercase tracking-tighter whitespace-nowrap z-10">
              <a href="#" className="text-gray-500 hover:text-[#1e1b4b] transition-colors">Terms and Conditions</a>
            </span>
            <span className="hidden lg:inline absolute bottom-[18%] right-[9%] text-[9px] xl:text-[11px] font-bold uppercase tracking-tighter whitespace-nowrap z-10">
          ...
          {/* ── TABLET + MOBILE (below lg): flex row, never overlaps canvas ── */}
