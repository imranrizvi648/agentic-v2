...
const slides = [
  {
    ...
    hasWebinarCard: true,
    hasLogos: true,
    hasPrimarySVG: true, // Flag for Slide 1 primary color SVG
...
export default function HeroSlider() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden transition-colors duration-1000">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          >
            {/* Slide 1 Decor: Primary Color Abstract SVG */}
            ...
            {/* Slide 2 Decor: White SVG Shade/Wave */}
          ...
          >
            ...
            <div className="hidden lg:block w-full max-w-[380px] mt-12 lg:mt-20">
              <AnimatePresence mode="wait">
                ...
                {/* Success Results (Slide 3) */}
                {slides[current].hasSuccessCards && (
                  <motion.div key="success" variants={containerVariants} initial="hidden" animate="visible" className="space-y-4">
