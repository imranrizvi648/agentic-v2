...
const CLIENT_LOGOS = [
  ...
  { id: 22, name: 'Everest',        src: '/clientLogo/logo-22.png' },
...
function PlaceholderMark({ seed = 0 }) {
  ...
  switch (variant) {
    case 0: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke={c} strokeWidth="2" /><circle cx="12" cy="12" r="3.5" fill={c} /></svg>;
    case 1: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M4 20 12 4l8 16H4Z" stroke={c} strokeWidth="2" strokeLinejoin="round" /></svg>;
    case 2: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="4" y="4" width="16" height="16" rx="2" stroke={c} strokeWidth="2" /><path d="M4 12h16M12 4v16" stroke={c} strokeWidth="1.5" /></svg>;
    case 3: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 3 21 8v8l-9 5-9-5V8l9-5Z" stroke={c} strokeWidth="2" strokeLinejoin="round" /></svg>;
    case 4: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M5 19V9l7-5 7 5v10" stroke={c} strokeWidth="2" strokeLinecap="round" /><circle cx="12" cy="13" r="2.5" fill={c} /></svg>;
    default: return <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M4 12a8 8 0 0 1 16 0" stroke={c} strokeWidth="2" strokeLinecap="round" /><path d="M20 12a8 8 0 0 1-16 0" stroke={c} strokeWidth="2" strokeLinecap="round" opacity="0.5" /></svg>;
  }
}
  ...
  return (
    <div className="cm-tile group/tile">
      {logo.src ? (
        ...
        <div className="cm-ph">
          <span className="cm-ph-mark"><PlaceholderMark seed={logo.id} /></span>
...
function LogoRow({ logos, reverse = false, duration = 46 }) {
  ...
  return (
    <div className="cm-viewport">
      <div className="cm-track" style={{ animationDuration: `${duration}s`, animationDirection: reverse ? 'reverse' : 'normal' }}>
        {doubled.map((l, i) => <LogoTile key={`${l.id}-${i}`} logo={l} />)}
      </div>
    </div>
  );
}
...
function LogoMarquee() {
  const rowA = CLIENT_LOGOS.slice(0, 11);
  const rowB = CLIENT_LOGOS.slice(11, 22);
  return (
...
function IndustryClientCard({ client }) {
  return (
    <div className="bg-white/5 rounded-xl border border-white/10 p-5 flex items-start gap-4
      ...
      <div className="flex-shrink-0 w-11 h-11 rounded-full bg-white/10 border border-white/20
  ...
  return (
    <section className="relative overflow-hidden bg-[#1a194d] py-20 text-white font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: 'radial-gradient(ellipse at 20% 60%, rgba(98,94,255,0.07) 0%, transparent 60%)' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-white/50 text-base max-w-xl mx-auto leading-[1.65]">
            Trusted by industry partners and enterprise clients across the GCC, South Asia and Europe.
          </p>
        </div>
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex gap-3">
            ...
            {(['industry', 'clients']).map((tab) => {
              ...
              const label     = tab === 'industry' ? 'Industry Partners' : 'Client Partners';
