...
const CLIENT_LOGOS = [
  {
    id: 1,
    name: "Acme Corp",
    src: "/homeImages/clientLogo/logo-1.webp",
  },
  {
    id: 2,
    name: "Vertex",
    src: "/homeImages/clientLogo/logo-2.webp",
  },
  {
    id: 3,
    name: "NovaBank",
    src: "/homeImages/clientLogo/logo-3.webp",
  },
  {
    id: 4,
    name: "Helix Health",
    src: "/homeImages/clientLogo/logo-4.webp",
  },
  {
    id: 5,
    name: "Orbit Retail",
    src: "/homeImages/clientLogo/logo-5.webp",
  },
  {
    id: 6,
    name: "Quanta",
    src: "/homeImages/clientLogo/logo-6.webp",
  },
  {
    id: 7,
    name: "Meridian",
    src: "/homeImages/clientLogo/logo-7.webp",
  },
  {
    id: 8,
    name: "Stratus",
    src: "/homeImages/clientLogo/logo-8.webp",
  },
  {
    id: 9,
    name: "Ironclad",
    src: "/homeImages/clientLogo/logo-9.webp",
  },
  {
    id: 10,
    name: "Bluewave",
    src: "/homeImages/clientLogo/logo-10.webp",
  },
  {
    id: 11,
    name: "Pinnacle",
    src: "/homeImages/clientLogo/logo-11.webp",
  },
  {
    id: 12,
    name: "Fintra",
    src: "/homeImages/clientLogo/logo-12.webp",
  },
  {
    id: 13,
    name: "Cedar Group",
    src: "/homeImages/clientLogo/logo-13.webp",
  },
  {
    id: 14,
    name: "Northgate",
    src: "/homeImages/clientLogo/logo-14.webp",
  },
  {
    id: 15,
    name: "Lumen Labs",
    src: "/homeImages/clientLogo/logo-15.webp",
  },
  {
    id: 16,
    name: "Axiom",
    src: "/homeImages/clientLogo/logo-16.webp",
  },
  {
    id: 17,
    name: "Solaris",
    src: "/homeImages/clientLogo/logo-17.webp",
  },
  {
    id: 18,
    name: "Cresta",
    src: "/homeImages/clientLogo/logo-18.webp",
  },
  {
    id: 19,
    name: "Vanguard",
    src: "/homeImages/clientLogo/logo-19.webp",
  },
  {
    id: 20,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-20.webp",
  },
  {
    id: 21,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-21.webp",
  },
  {
    id: 22,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-22.webp",
  },
  {
    id: 23,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-23.webp",
  },
  {
    id: 24,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-24.webp",
  },
  {
    id: 25,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-25.webp",
  },
  {
    id: 26,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-26.webp",
  },
  {
    id: 27,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-27.webp",
  },
  {
    id: 28,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-28.webp",
  },
  {
    id: 29,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-29.webp",
  },
  {
    id: 30,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-30.webp",
  },
  {
    id: 31,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-31.webp",
  },
  {
    id: 32,
    name: "Eclipse",
    src: "/homeImages/clientLogo/logo-32.webp",
  },
];
    ...
    <div className="cm-wrap">
      ...
      <style>{`
        ...
        .cm-tile:hover {
          ...
          box-shadow:
            0 12px 34px rgba(98, 94, 255, 0.16);
        }
...
function IndustryClientCard({ client }) {
  return (
    <div
      className="
        bg-white/5 rounded-xl border border-white/10 p-5
...
export default function Partnerships() {
  ...
  const handlePartnerSelect = (id) => {
    ...
    // Non-clickable partners cannot be selected
    if (!partner?.clickable) return;

    setActivePartner(
      activePartner === id ? null : id
    );
  };
        ...
        >
          ...
          <p
            className="
              text-white/50
              text-base max-w-xl
              mx-auto leading-[1.65]
            "
          >
            Trusted by industry partners and
            enterprise clients across the GCC,
          ...
          <div>
            ...
            >
              {INDUSTRY_PARTNERS.map(({ id }) => {
                ...
                // This controls whether the partner
            ...
            {activePartner &&
              partnerData[activePartner]?.clickable !==
                false && (
                <div
                  className="
                    relative bg-white/5
