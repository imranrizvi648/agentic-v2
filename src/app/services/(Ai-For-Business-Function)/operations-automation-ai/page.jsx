...
const hero = {
  number: "04",
  tagline: "AI for Business Functions · Operations",
  headline: "Agentic AI for Operations and Shared Services",
  highlight: "Operations and Shared Services",
  sub: "Transform fragmented back-office work into coordinated execution. Agents interpret requests, retrieve context, use authorized tools and move work across teams with clear controls and ownership.",
  cta1: "Discuss Your Workflow",
  cta2: "Explore Sub-Services",
  badges: ["Email", "Workflow Platforms", "ERP", "CRM · Service Management"],
};

const overview = {
  heading: "End-to-end flow — not isolated tasks",
  lead: "Many operational processes are not difficult because of a single task; they are difficult because work moves through email, spreadsheets, documents, portals and multiple owners.",
  body: "Our agents coordinate the end-to-end flow, detect exceptions and maintain an auditable record of what happened.",
};
...
const sectors = [
  {
    ...
    body: "Increase operational capacity, reduce turnaround time and standardize service delivery without rebuilding every existing system.",
  },
  {
    id: "public",
    title: "Public sector",
    body: "Improve case processing, internal administration, citizen-facing turnaround and adherence to documented procedures.",
  },
];
...
const subServices = [
  {
    title: "Email-to-Action Automation",
    body: "Interpret inbound emails and attachments, identify the required process, create tasks or records and route work to the correct owner.",
  },
  {
    title: "Case and Request Management",
    body: "Create, enrich, prioritize and monitor cases across departments while maintaining status and evidence.",
  },
  {
    title: "Approval Workflow Coordination",
    body: "Collect required inputs, apply approval matrices, remind owners and record decisions.",
  },
  {
    title: "Data Entry and Record Synchronization",
    body: "Extract approved information and update multiple systems with validation, reconciliation and retry controls.",
  },
  {
    title: "SOP-Guided Execution",
    body: "Guide staff or agents through the current approved procedure and flag deviations or missing steps.",
  },
  {
    title: "Cross-Department Handoffs",
    body: "Package context, evidence and next actions so work moves between teams without information loss.",
  },
  {
    title: "Exception Detection and Resolution Support",
    body: "Identify missing data, rule failures, delays or conflicting records and prepare a resolution path.",
  },
  {
    title: "Operational Reporting",
    body: "Prepare throughput, backlog, aging, service-level and exception summaries for process owners.",
  },
  {
    title: "Forms and Application Processing",
    body: "Validate forms and supporting documents, identify missing items and coordinate follow-up.",
  },
];

const workflowSteps = [
  { num: "01", title: "Receive request from email, form, document or system event" },
  { num: "02", title: "Determine process, priority and responsible service" },
  { num: "03", title: "Retrieve record, policy and historical context" },
  { num: "04", title: "Perform configured checks and permitted actions" },
  { num: "05", title: "Coordinate approvals and cross-team handoffs" },
  { num: "06", title: "Escalate exceptions with complete evidence" },
  { num: "07", title: "Update systems and notify stakeholders" },
  { num: "08", title: "Measure cycle time, backlog and quality" },
];

const systems =
  "Email, workflow platforms, ERP, CRM, service management, document repositories, databases, portals and line-of-business applications.";

const controls = [
  { title: "Process ownership", desc: "Clear ownership of every process step and exception path." },
  { title: "Approval matrices", desc: "Configured approval rules and escalation paths are enforced." },
  { title: "Action permissions", desc: "Agents only perform actions explicitly allowed by policy." },
  { title: "Idempotent system updates", desc: "Updates are designed to be safe on retry and avoid duplicates." },
  { title: "Exception recovery", desc: "Missing data, rule failures and conflicts surface with full evidence." },
  { title: "Data validation & audit logs", desc: "Validation rules and complete audit trails are retained." },
];
...
const faqs = [
  {
    q: "Which operations & shared services workflows can AI agents support?",
    a: "Agents support email-to-action automation, case and request management, approval coordination, data entry and record sync, SOP-guided execution, cross-department handoffs, exception detection, operational reporting, and forms processing — with process ownership and human approvals where required.",
  },
  {
    q: "How are integrations, approvals and sensitive data handled?",
    a: "We connect to email, workflow platforms, ERP, CRM, service management and document systems through approved interfaces. Approval matrices and action permissions are enforced, system updates are designed to be safe on retry, exceptions are recovered with evidence, and full audit logs are retained.",
  },
];

const cta = {
  heading: "Ready to put governed agents on your operational workflows?",
  body: "Tell us how email, forms, approvals and cases move today. We will map where agents can coordinate the flow while process owners keep control.",
  cta1: "Discuss Your Workflow",
...
export default function OperationsAutomationPage() {
  ...
  return (
    <main className="bg-white text-brand-primary selection:bg-brand-secondary/20">
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section
        aria-label="Operations and Shared Services AI service header"
            ...
            <div className="lg:col-span-7">
              <div className="mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-brand-primary tracking-tight">
                  Built for commercial operations and public administration
                </h3>
              </div>
      ...
      <section className="py-16 sm:py-20 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-10 max-w-2xl">
            Where back-office work breaks down
          </h2>
      ...
      <section id="sub-services" className="py-16 sm:py-20 bg-slate-50/60 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-3 max-w-2xl">
            Capabilities across the operations lifecycle
          </h2>
          <p className="text-sm text-brand-primary/60 mb-12 max-w-2xl">
            Agents coordinate the flow. Process owners keep control of approvals and exceptions.
          </p>
      ...
      <section className="py-16 sm:py-20 border-b border-white/10 bg-[#12103c] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-12 max-w-2xl">
            From request to measured outcome
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-brand-primary tracking-tight mb-4">
                Connected to your operations stack
              </h2>
...
/>
      ...
      <section className="py-16 sm:py-20 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-10 max-w-2xl">
            Results operations leaders track
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {outcomes.map((o) => (
              <div
      ...
      <section className="py-16 sm:py-20 bg-slate-50/50 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-8">
              <div className="bg-white p-6 sm:p-8 rounded-2xl border border-brand-primary/10 shadow-sm flex flex-col justify-between h-full">
                <div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-brand-primary/30 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {relatedServices.map((r) => (
              <Link
                key={r.slug}
                href={r.slug}
                className="group rounded-xl border border-brand-primary/10 p-5 hover:border-brand-secondary/30 hover:bg-brand-secondary/5 transition-all"
              >
                <span className="text-[10px] font-bold tracking-widest text-brand-secondary block mb-2">
                  {r.number}
                </span>
                <span className="text-sm font-bold text-brand-primary group-hover:text-brand-secondary transition-colors">
                  {r.title}
                </span>
              </Link>
            ))}
