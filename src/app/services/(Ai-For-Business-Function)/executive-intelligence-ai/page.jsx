...
const hero = {
  number: "07",
  tagline: "AI for Business Functions · Executive Intelligence",
  headline: "Agentic AI for Executive Intelligence and Decisions",
  highlight: "Executive Intelligence and Decisions",
  sub: "Turn fragmented operational data into timely, evidence-backed management intelligence. Our agents monitor signals, investigate deviations and prepare concise decision material without replacing executive accountability.",
  cta1: "Discuss Your Workflow",
  cta2: "Explore Sub-Services",
  badges: ["Power BI", "Microsoft Fabric", "ERP · CRM", "Planning Systems"],
};

const overview = {
  heading: "Timely briefings with the conclusion and its source",
  lead: "Leadership teams often receive delayed, inconsistent or manually assembled reporting.",
  body: "AgenticSense connects approved data and documents, investigates what changed, identifies missing evidence and prepares briefings that show both the conclusion and its source.",
};
...
const sectors = [
  {
    ...
    body: "Improve decision speed, business visibility, performance management and early identification of operational or commercial risk.",
  },
  {
    id: "public",
    title: "Public sector",
    body: "Support program oversight, service-performance monitoring, policy implementation, budget visibility and accountable executive reporting.",
  },
];
...
const subServices = [
  {
    ...
    body: "Continuously monitor approved indicators, thresholds and trends across functions or programs.",
  },
  {
    title: "Variance and Anomaly Investigation",
    body: "Detect unusual changes, retrieve related evidence and prepare possible drivers for human review.",
  },
  {
    title: "Management Commentary Agent",
    body: "Draft concise performance commentary linked to underlying reports, transactions and operational events.",
  },
  {
    title: "Decision Briefing Preparation",
    body: "Structure the issue, evidence, options, trade-offs, risks and required decision in an executive-ready format.",
  },
  {
    title: "Forecast and Scenario Support",
    body: "Combine approved assumptions and historical data to compare scenarios without presenting uncertain forecasts as facts.",
  },
  {
    title: "Market and Competitor Intelligence",
    body: "Monitor defined public sources, detect relevant changes and prepare source-linked strategic updates.",
  },
  {
    title: "Program and Portfolio Oversight",
    body: "Track initiatives, milestones, dependencies, outcomes and unresolved decisions across a portfolio.",
  },
  {
    title: "Risk and Exception Alerts",
    body: "Surface material operational, financial, compliance or service risks based on defined thresholds.",
  },
  {
    title: "Board and Committee Pack Support",
    body: "Collect approved contributions, validate completeness and prepare consistent pack sections for review.",
  },
];

const workflowSteps = [
  { num: "01", title: "Monitor scheduled data and approved sources" },
  { num: "02", title: "Validate freshness and completeness" },
  { num: "03", title: "Detect threshold breaches or material changes" },
  { num: "04", title: "Retrieve supporting operational evidence" },
  { num: "05", title: "Investigate likely drivers and competing explanations" },
  { num: "06", title: "Prepare briefing with confidence and limitations" },
  { num: "07", title: "Route to accountable executive or analyst" },
  { num: "08", title: "Record decisions and track resulting actions" },
];

const systems =
  "Data warehouses, Microsoft Fabric, Power BI, ERP, CRM, planning systems, project platforms, document repositories and approved external information sources.";

const controls = [
  { title: "Data lineage", desc: "Every figure and claim can be traced to an approved source system or document." },
  { title: "Freshness checks", desc: "Stale or incomplete data is flagged before briefings are finalized." },
  { title: "Source citation", desc: "Conclusions are paired with the underlying evidence, not presented in isolation." },
  { title: "Confidence disclosure", desc: "Limitations and uncertainty are stated so executives are not misled." },
  { title: "Approval before distribution", desc: "Material briefings can require analyst or owner sign-off before wider circulation." },
  { title: "Restricted executive data & decision authority", desc: "Sensitive data access is controlled; recommendations never replace executive decisions." },
];
...
const faqs = [
  {
    q: "Which executive intelligence workflows can AI agents support?",
    a: "Agents support executive KPI monitoring, variance and anomaly investigation, management commentary, decision briefing preparation, forecast and scenario support, market and competitor intelligence, program and portfolio oversight, risk and exception alerts, and board pack support — without replacing executive accountability.",
  },
  {
    q: "How are integrations, approvals and sensitive data handled?",
    a: "We connect to data warehouses, Microsoft Fabric, Power BI, ERP, CRM, planning and project systems through approved interfaces. Briefings include lineage, freshness checks and source citations; confidence and limitations are disclosed; distribution can require approval; executive data is restricted; and decision authority stays with accountable leaders.",
  },
];

const cta = {
  heading: "Ready to put governed agents on executive intelligence?",
  body: "Tell us which KPIs, reports and decision packs matter most. We will map where agents can monitor, investigate and brief — while executives keep ownership of decisions.",
  cta1: "Discuss Your Workflow",
...
export default function ExecutiveIntelligencePage() {
  ...
  return (
    <main className="bg-white text-brand-primary selection:bg-brand-secondary/20">
      {/* Hero */}
      <section
        aria-label="Executive Intelligence and Decisions AI service header"
            ...
            <div className="lg:col-span-7">
              <div className="mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-brand-primary tracking-tight">
                  Built for commercial leadership and public program oversight
                </h3>
              </div>
      ...
      <section className="py-16 sm:py-20 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-10 max-w-2xl">
            Where management intelligence falls short
          </h2>
      ...
      <section id="sub-services" className="py-16 sm:py-20 bg-slate-50/60 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-3 max-w-2xl">
            What agents deliver for executive intelligence
          </h2>
          <p className="text-sm text-brand-primary/60 mb-12 max-w-2xl">
            Agents monitor, investigate and brief. Executives retain accountability for every decision.
          </p>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-12 max-w-2xl">
      From monitored signal to tracked decision
    </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-brand-primary tracking-tight mb-4">
                Connected to the data leadership already trusts
              </h2>
...
/>
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-brand-primary tracking-tight mb-6">
                Guardrails that keep recommendations honest
              </h2>
      ...
      <section className="py-16 sm:py-20 border-b border-brand-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-brand-primary tracking-tight mb-10 max-w-2xl">
            Results executives and analysts track
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {outcomes.map((o) => (
              <div
