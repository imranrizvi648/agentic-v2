...
const hero = {
  eyebrow: "06 · Industries · Retail & Distribution",
  headline: "Agentic AI Solutions for Retail & Distribution",
  sub:
    "Retail and distribution organizations operate across customer demand, inventory, suppliers, warehouses, orders, pricing, logistics and commercial systems. AgenticSense helps teams turn fragmented information into coordinated action across merchandising, procurement, inventory, fulfillment, customer service, reporting and operational workflows while keeping important business decisions under human control.",
...
const workflows = [
  {
    num: "01",
    title: "Merchandising & Category Operations",
    body:
      "Bring together product, sales and category information to help teams identify trends, prepare recommendations and move recurring merchandising workflows forward.",
  },
  {
    num: "02",
    title: "Inventory Management",
    body:
      "Support inventory teams by organizing stock information, identifying exceptions and preparing structured actions around availability, replenishment and slow-moving inventory.",
  },
  {
    num: "03",
    title: "Order & Fulfillment Operations",
    body:
      "Coordinate order information, fulfillment status and operational exceptions so teams can identify issues, prepare responses and move customer orders forward.",
  },
  {
    num: "04",
    title: "Supply & Procurement",
    body:
      "Organize supplier information, purchasing records and procurement documentation while helping teams identify missing information and prepare purchasing workflows.",
  },
  {
    num: "05",
    title: "Customer Service Operations",
    body:
      "Understand customer requests, order context and relevant business information to route cases, prepare responses and coordinate actions across service teams.",
  },
  {
    num: "06",
    title: "Distribution & Logistics",
    body:
      "Help teams coordinate warehouse, shipment, delivery and distribution information while identifying operational exceptions that require attention.",
  },
];
...
const environments = [
  {
    ...
    text:
      "Connect information across merchandising, inventory, pricing, stores, customer service and commercial workflows so teams can respond to changing demand with better context.",
  },
  {
    title: "Distribution Operations",
    text:
      "Support high-volume environments where orders, inventory, warehouses, suppliers and logistics information need to move quickly and accurately.",
  },
  {
    title: "E-commerce",
    text:
      "Coordinate product, order, customer, inventory and fulfillment information across digital commerce workflows without creating another disconnected technology layer.",
  },
  {
    title: "Corporate Functions",
    text:
      "Extend intelligent workflows into finance, HR, reporting, compliance and internal knowledge processes that support retail and distribution organizations.",
  },
];
...
const governance = [
  [
    "01",
    "Commercial Controls",
    "Define which workflows AI can support, which actions require approval and which commercial decisions must remain with authorized teams.",
  ],
  [
    "02",
    "Data & Access",
    "Control how customer, product, pricing, supplier, inventory and operational information is accessed and used across AI-assisted workflows.",
  ],
  [
    "03",
  ...
  [
    "04",
    "Human Approval",
    "Keep qualified commercial, operations, procurement and management teams involved wherever judgment, authorization or exception handling is required.",
  ],
];
...
const implementation = [
  {
    ...
    text:
      "Identify processes where teams spend significant time gathering information, checking orders, reviewing inventory, coordinating suppliers or responding to customer and operational exceptions.",
  ...
  },
  {
    ...
    text:
      "Map the people, systems, information, business rules and approval points involved in the selected retail or distribution process before defining the AI workflow.",
  ...
  },
  {
    ...
    text:
      "Deploy one focused workflow with clear boundaries, measurable outcomes and human review points before expanding the solution across additional teams or locations.",
    left: "Defined scope",
  ...
  },
  {
    ...
    text:
      "Extend successful workflows across additional stores, warehouses, suppliers, product categories, regions or business functions once value and governance are established.",
    left: "More workflows",
...
const impact = [
  [
    ...
    "Help teams gather relevant information and move inventory, fulfillment, supplier and customer issues forward with less manual coordination.",
  ],
  [
    "Lower administrative effort",
    "Reduce repetitive information-handling activities across merchandising, procurement, inventory, customer service and distribution operations.",
  ],
  [
    "Better inventory visibility",
    "Bring information together across stock, demand, orders, suppliers and distribution workflows.",
  ],
  [
    "More consistent processes",
    "Apply defined business rules and workflow requirements across recurring commercial and operational activities.",
  ],
  [
    "Improved exception handling",
    "Help teams identify missing information, stock exceptions, order issues and cases that require immediate attention.",
  ],
  [
    "More capacity for higher-value work",
    "Give retail and distribution teams more time to focus on customers, suppliers, merchandising, planning and strategic decisions.",
  ],
];
...
const faqs = [
  {
    ...
    a:
      "Agentic AI refers to AI systems that can understand a defined objective, work with relevant business information, perform multiple workflow steps and involve people when judgment or approval is required. In retail, this can support merchandising, inventory, customer service, procurement, fulfillment and reporting workflows.",
  },
  {
    q: "Can Agentic AI work with existing retail systems?",
    a:
      "Yes. Agentic AI can be designed to work across existing ERP, POS, e-commerce, CRM, warehouse, inventory, procurement, reporting and document systems rather than requiring organizations to replace their existing technology.",
  },
  {
    q: "Can AI automatically change prices or inventory decisions?",
    a:
      "AI can support analysis, recommendations, monitoring and workflow preparation, but important pricing, inventory and commercial decisions should remain subject to appropriate business rules, authorization and human oversight.",
  },
  {
    q: "How can AI help distribution operations?",
    a:
      "AI can help coordinate information across orders, inventory, warehouses, suppliers, shipments and delivery operations. It can identify exceptions, prepare information and route tasks while keeping important operational decisions with responsible teams.",
  },
  {
    q: "Can Agentic AI support customer service?",
    a:
      "Yes. AI can understand customer requests, retrieve relevant order and account information, prepare responses and coordinate follow-up actions. Cases requiring judgment or authorization can be escalated to the appropriate service team.",
  },
  {
    q: "Do we need to automate an entire retail department?",
    a:
...
export default function RetailDistributionPage() {
  ...
  return (
    <main className="bg-white text-brand-primary selection:bg-brand-secondary/20">
      ...
      <section
        aria-label="Retail and Distribution AI"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-8">
              ...
              <div className="p-6 rounded-xl bg-white border border-brand-primary/10 shadow-sm relative overflow-hidden">
                ...
                <p className="text-sm text-brand-primary/70 leading-relaxed">
                  Fragmented customer, inventory, supplier and order
                  information creates operational friction across retail
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-base sm:text-lg font-semibold leading-relaxed text-brand-primary">
                Modern retail and distribution organizations operate
                across stores, e-commerce platforms, ERP systems,
                warehouses, suppliers, logistics networks and customer
                channels.
              </p>
              ...
              <p className="mt-6 text-sm text-brand-primary/65 leading-relaxed">
                ...
                checking orders, reviewing inventory, coordinating teams
                and following up on exceptions.
              </p>

              <p className="mt-4 text-sm text-brand-primary/65 leading-relaxed">
                Merchandising teams review product performance. Inventory
                teams monitor stock. Procurement teams coordinate suppliers.
                Fulfillment teams manage orders. Customer service teams
                respond to requests and commercial teams coordinate demand
              ...
              <p className="mt-4 text-sm text-brand-primary/65 leading-relaxed">
                ...
                with business information, perform defined tasks and
                involve people when commercial or operational judgment is
                required.
              </p>
              ...
              <div className="mt-8 border-l-2 border-brand-secondary/50 pl-5">
                <p className="text-xl sm:text-2xl font-bold leading-relaxed text-brand-primary">
                  ...
                  <br />
                  More time serving customers and improving operations.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-8 self-start">
              ...
              <p className="mt-5 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Retail and distribution organizations depend on connected
                processes from product planning and sourcing to inventory,
                fulfillment, customer service and delivery.
              </p>
            </div>
            ...
            <div className="lg:col-span-8">
              ...
              <div className="divide-y divide-brand-primary/10 border-y border-brand-primary/10">
                ...
                {[
                  [
                    "01",
                    "Plan",
                    "Demand, assortment, inventory and commercial information",
                  ],
                  [
                    "02",
                    "Source",
                  ...
                  [
                    "03",
                    "Stock",
                    "Inventory, warehouses and product availability",
                  ],
                  [
                    "04",
                    "Fulfill",
                    "Orders, logistics and distribution",
                  ],
                  [
                    "05",
                    "Serve",
                    "Customers, service and commercial operations",
                  ],
                ].map(([num, title, text]) => (
                  <div
                    key={num}
              ...
              <div className="mt-8">
                <p className="text-base sm:text-lg font-bold leading-relaxed">
                  Connected commerce requires more than connected systems.
                  <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-5">
              <p className="text-sm text-white/55 leading-relaxed">
                High-volume retail and distribution workflows often
                involve multiple systems, teams and decisions. Agentic AI
                can help connect the work between them.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-14">
            ...
            <p className="mt-4 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
              ...
              defined business objective instead of treating every task as
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
            ...
            {[
              [
                "01",
                "Understand",
                "Identify the business objective, relevant context, available information and applicable business rules.",
              ],
              [
                "02",
                "Coordinate",
                "Retrieve information, perform defined tasks and move the workflow across connected retail and distribution systems.",
              ],
              [
                "03",
                "Validate",
              ...
              [
                "04",
                "Escalate",
                "Bring the right commercial or operational team into the process when judgment, approval or exception handling is required.",
              ],
            ].map(([num, title, text]) => (
          ...
          <div className="mt-16 pt-8 border-t border-brand-primary/10">
            ...
            <p className="text-base sm:text-lg font-bold leading-relaxed text-brand-primary">
              ...
              <span className="block sm:inline text-brand-primary/45 font-normal mt-1 sm:mt-0">
                Commercial and operational teams remain in control of the
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="mt-5 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Agentic AI should not require retail and distribution
              ...
              <p className="mt-4 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                ...
                POS, e-commerce, inventory, warehouse, CRM, procurement,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 rounded-xl bg-[#12103c] p-7 sm:p-8">
                ...
                <p className="mt-5 text-sm text-white/50 leading-relaxed">
                  ...
                  especially when workflows can affect customers, pricing,
                  inventory, suppliers or fulfillment.
                </p>
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-sm sm:text-base text-brand-primary/65 leading-relaxed max-w-2xl">
                ...
                so automation supports retail operations without removing
                accountability.
              </p>
              ...
              <p className="mt-8 text-lg sm:text-xl font-bold tracking-tight">
                AI should make commerce faster
                <span className="text-brand-primary/45">
                  {" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                ...
                transformation. Start with one retail or distribution
                workflow, prove measurable value and expand from there.
              </p>
          ...
          <div className="mt-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-t border-brand-primary/10 pt-7">
            ...
            <p className="text-sm text-brand-primary/50 max-w-md leading-relaxed">
              ...
              stores, warehouses, regions and business functions.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm sm:text-base text-white/55 leading-relaxed">
                ...
                content an AI system can produce. For retail and
                distribution organizations, the meaningful question is how
                much operational work can move forward with less manual
                effort.
              </p>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-6 sm:p-7">
                ...
                <h3 className="mt-4 text-xl sm:text-2xl font-bold text-brand-primary tracking-tight leading-tight">
                  Ready to put governed agents into your retail operations?
                </h3>

                <p className="mt-3 text-sm text-brand-primary/60 leading-relaxed">
                  Tell us how your teams manage inventory, orders,
                  merchandising, procurement, fulfillment, distribution or
                  customer operations. We will identify where Agentic AI
                  can reduce friction while keeping important business
