...
const hero = {
  eyebrow: "05 · Industries · Manufacturing & FMCG",
  headline: "Agentic AI Solutions for Manufacturing & FMCG",
  sub:
    "Manufacturing and FMCG organizations operate across production data, supply chains, procurement, quality records, inventory, customer demand and operational systems. AgenticSense helps teams turn fragmented information into coordinated action across planning, procurement, quality, operations, reporting and customer workflows while keeping critical operational decisions under human control.",
...
const workflows = [
  {
    ...
    body:
      "Bring together production information, operational records and defined business rules to help teams identify exceptions, prepare actions and move routine workflows forward.",
  },
  {
    num: "02",
    title: "Procurement & Supplier Operations",
    body:
      "Support purchase workflows by organizing supplier information, reviewing documentation, identifying missing data and preparing structured cases for procurement teams.",
  },
  {
    num: "03",
    title: "Quality Management",
    body:
      "Help teams organize quality records, inspection information, non-conformance documentation and corrective-action workflows with clear evidence and human review.",
  },
  {
    num: "04",
    title: "Demand & Supply Planning",
    body:
      "Bring together demand signals, inventory information and operational data to help planning teams prepare scenarios, identify exceptions and coordinate follow-up actions.",
  },
  {
    num: "05",
    title: "Inventory & Distribution",
    body:
      "Reduce repetitive information handling across inventory, logistics and distribution workflows while helping teams identify priorities and operational exceptions.",
  },
  {
    num: "06",
    title: "Customer & Order Operations",
    body:
      "Understand incoming requests, order information and customer context to route work, prepare responses and coordinate actions across commercial and operational teams.",
  },
];
...
const environments = [
  {
    ...
    text:
      "Connect information across production, maintenance, quality, procurement and planning workflows so teams can respond to operational issues with better context.",
  },
  {
    title: "FMCG Operations",
    text:
      "Support high-volume commercial and operational environments where demand, inventory, distribution, customer orders and supplier information need to move quickly.",
  },
  {
    title: "Supply Chain",
    text:
      "Help teams coordinate information across suppliers, procurement, inventory, logistics and distribution without creating another disconnected technology layer.",
  },
  {
    title: "Corporate Functions",
    text:
      "Extend intelligent workflows into finance, HR, reporting, compliance and internal knowledge processes that support manufacturing and FMCG organizations.",
  },
];
...
const governance = [
  [
    ...
    "Define which workflows AI can execute, which actions require approval and which operational decisions must remain with authorized teams.",
  ],
  [
    "02",
    "Data & Access",
    "Control how operational, commercial, supplier and customer information is accessed and used across AI-assisted workflows.",
  ],
  [
    "03",
    "Evidence & Traceability",
    "Keep workflow outputs connected to source information so teams can understand the evidence behind AI-assisted actions.",
  ],
  [
    "04",
    "Human Approval",
    "Keep qualified operational, procurement, quality and management teams involved wherever judgment or authorization is required.",
  ],
];
...
const implementation = [
  {
    ...
    text:
      "Identify processes where teams spend significant time gathering information, checking documents, coordinating requests or responding to operational exceptions.",
  ...
  },
  {
    ...
    text:
      "Map the people, systems, information, business rules and approval points involved in the selected process before defining the AI workflow.",
  ...
  },
  {
    ...
    text:
      "Deploy one focused workflow with clear boundaries, measurable outcomes and human review points before expanding the solution.",
    left: "Defined scope",
  ...
  },
  {
    ...
    text:
      "Extend successful workflows across additional plants, departments, suppliers, products or business functions once value and governance are established.",
    left: "More workflows",
...
const impact = [
  [
    ...
    "Help teams gather relevant information and move operational issues forward with less manual coordination.",
  ],
  [
    "Lower administrative effort",
    "Reduce repetitive information-handling activities across procurement, quality, planning and commercial operations.",
  ],
  [
    "Better supply chain visibility",
    "Bring information together across suppliers, inventory, demand and distribution workflows.",
  ],
  [
    "More consistent processes",
    "Apply defined business rules and workflow requirements across recurring operational activities.",
  ],
  [
    "Improved exception handling",
    "Help teams identify missing information, operational exceptions and cases that require attention.",
  ],
  [
    "More capacity for higher-value work",
    "Give operational teams more time to focus on planning, improvement, customers, suppliers and strategic decisions.",
  ],
];
...
const faqs = [
  {
    ...
    a:
      "Agentic AI refers to AI systems that can understand a defined objective, work with relevant business information, perform multiple workflow steps and involve people when judgment or approval is required. In manufacturing, this can support production operations, procurement, quality, planning, reporting and internal knowledge workflows.",
  },
  {
    q: "Can Agentic AI work with existing manufacturing systems?",
    a:
      "Yes. Agentic AI can be designed to work across existing ERP, MES, CRM, procurement, quality, document management, reporting and other enterprise systems rather than requiring organizations to replace their existing technology.",
  },
  {
    q: "Can AI control production processes automatically?",
    a:
      "AI can support information gathering, monitoring, workflow coordination and operational preparation, but critical production decisions and actions should remain subject to appropriate controls, authorization and human oversight.",
  },
  {
    q: "How can AI help FMCG supply chains?",
    a:
      "AI can help coordinate information across demand planning, procurement, inventory, suppliers, distribution and customer operations. It can identify exceptions, prepare information and route tasks while keeping important decisions with responsible teams.",
  },
  {
    q: "Can Agentic AI support quality management?",
    a:
      "Yes. AI can help organize quality documentation, inspection records, non-conformance information and corrective-action workflows. Outputs can remain connected to source evidence and routed to qualified teams for review.",
  },
  {
    q: "Do we need to automate an entire department?",
    a:
...
export default function ManufacturingFMCGPage() {
  ...
  return (
    <main className="bg-white text-brand-primary selection:bg-brand-secondary/20">
      ...
      <section
        aria-label="Manufacturing and FMCG AI"
...
<section className="py-16 sm:py-24 border-b border-brand-primary/10 bg-slate-50/50">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
      ...
      {/* Left Column (Ab yahan khali pan nahi lagega) */}
      <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-8">
        ...
        <div className="p-6 rounded-xl bg-white border border-brand-primary/10 shadow-sm relative overflow-hidden">
          ...
          <p className="text-sm text-brand-primary/70 leading-relaxed">
            Disconnected data and manual exception handling slow down production pipelines across departments.
          </p>
          <div className="mt-4 pt-3 border-t border-brand-primary/10 flex items-center justify-between text-xs text-brand-primary/50">
            ...
            <span className="font-bold text-brand-secondary">Manual Coordination</span>
          </div>
        </div>
      </div>

      {/* Right Column (Aapka exact purana code, bilkul untouched) */}
      <div className="lg:col-span-7">
        <p className="text-base sm:text-lg font-semibold leading-relaxed text-brand-primary">
          Modern manufacturers and FMCG organizations operate across
          production systems, ERP platforms, suppliers, warehouses,
          quality teams, commercial operations and distribution networks.
        </p>
        ...
        <p className="mt-4 text-sm text-brand-primary/65 leading-relaxed">
          Procurement teams review supplier information. Quality teams
          investigate records. Planners respond to changing demand.
          Operations teams manage exceptions. Commercial teams coordinate
        ...
        <div className="mt-8 border-l-2 border-brand-secondary/50 pl-5">
          <p className="text-xl sm:text-2xl font-bold leading-relaxed text-brand-primary">
            ...
            <br />
              ...
              More time improving operations.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-8 self-start">
              ...
              <p className="mt-5 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Manufacturing and FMCG organizations depend on connected
                processes from sourcing to production, distribution and
                customer delivery.
              </p>
            ...
            <div className="lg:col-span-8">
              ...
              <div className="divide-y divide-brand-primary/10 border-y border-brand-primary/10">
                ...
                {[
                  [
                    "01",
                    "Plan",
                    "Demand, supply and production information",
                  ],
                  [
                    "02",
                    "Source",
                    "Suppliers, procurement and purchasing",
                  ],
                  [
                    "03",
                    "Produce",
                    "Production, quality and operational records",
                  ],
                  [
                    "04",
                    "Move",
              ...
              <div className="mt-8">
                ...
                <p className="text-base sm:text-lg font-bold leading-relaxed">
                  Connected operations require more than connected systems.
                  <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm text-white/55 leading-relaxed">
                High-volume manufacturing and FMCG workflows often involve
                multiple systems, teams and decisions. Agentic AI can help
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="max-w-3xl mb-14">
      ...
      <p className="mt-4 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
        Agentic AI can coordinate multiple workflow steps around a defined business objective instead of treating every task as an isolated automation.
      </p>
    </div>

    {/* Clean Non-Card Row Layout */}
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
      {[
        [
          "01",
          "Understand",
          "Identify the operational objective, relevant context, available information and business rules.",
        ],
        [
          "02",
          "Coordinate",
        ...
        [
          "04",
          "Escalate",
          "Bring the right operational team into the process when judgment, approval or exception handling is required.",
        ],
      ].map(([num, title, text]) => (
    ...
    <div className="mt-16 pt-8 border-t border-brand-primary/10">
      <p className="text-base sm:text-lg font-bold leading-relaxed text-brand-primary">
        ...
        <span className="block sm:inline text-brand-primary/45 font-normal mt-1 sm:mt-0">
          Operational teams remain in control of the decisions that matter.
        </span>
      </p>
    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white p-6 sm:p-8 rounded-2xl border border-brand-primary/10 shadow-sm">
                ...
                {/* Simple List Grid for the 4 Systems */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  
                  <div className="p-4 rounded-xl bg-slate-50 border border-brand-primary/5">
                    <p className="text-sm font-bold text-brand-primary">ERP</p>
                    <p className="mt-1 text-xs text-brand-primary/50">Finance & operations</p>
                  </div>

                  <div className="p-4 rounded-xl bg-slate-50 border border-brand-primary/5">
                    <p className="text-sm font-bold text-brand-primary">Production Systems</p>
                    <p className="mt-1 text-xs text-brand-primary/50">Plant & manufacturing</p>
                  </div>

                  <div className="p-4 rounded-xl bg-slate-50 border border-brand-primary/5">
                    <p className="text-sm font-bold text-brand-primary">Supply Chain</p>
                    <p className="mt-1 text-xs text-brand-primary/50">Inventory & logistics</p>
                  </div>

                  <div className="p-4 rounded-xl bg-slate-50 border border-brand-primary/5">
                    <p className="text-sm font-bold text-brand-primary">Quality & Documents</p>
                    <p className="mt-1 text-xs text-brand-primary/50">Evidence & records</p>
                  </div>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 rounded-xl bg-[#12103c] p-7 sm:p-8">
                ...
                <p className="mt-5 text-sm text-white/50 leading-relaxed">
                  ...
                  when workflows can affect production, quality, suppliers or
                  customers.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-t border-brand-primary/10 pt-7">
            ...
            <p className="text-sm text-brand-primary/50 max-w-md leading-relaxed">
              ...
              departments, plants and business functions.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm sm:text-base text-white/55 leading-relaxed">
                ...
                content an AI system can produce. For manufacturers and FMCG
            ...
            <div className="lg:col-span-5">
              ...
              <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-6 sm:p-7">
                ...
                <h3 className="mt-4 text-xl sm:text-2xl font-bold text-brand-primary tracking-tight leading-tight">
                  Ready to put governed agents into your operations?
                </h3>

                <p className="mt-3 text-sm text-brand-primary/60 leading-relaxed">
                  Tell us how your teams manage procurement, production,
                  quality, supply chain or customer operations. We will identify
                  where Agentic AI can reduce friction while keeping operational
