...
const hero = {
  eyebrow: "08 · Industries · Agriculture & Food",
  headline: "Agentic AI Solutions for Agriculture & Food",
  sub:
    "Agriculture and food organizations operate across farms, suppliers, procurement, production, quality, inventory, distribution, demand and customer operations. AgenticSense helps teams turn fragmented information into coordinated action across planning, sourcing, quality, operations, reporting and customer workflows while keeping critical business decisions under human control.",
...
const workflows = [
  {
    num: "01",
    title: "Farm & Field Operations",
    body:
      "Bring together field information, operational records, schedules and defined business rules to help teams identify exceptions, prepare actions and coordinate recurring agricultural workflows.",
  },
  {
    num: "02",
    title: "Procurement & Supplier Operations",
    body:
      "Support sourcing and purchasing workflows by organizing supplier information, reviewing documentation, identifying missing data and preparing structured cases for procurement teams.",
  },
  {
    num: "03",
    title: "Quality & Compliance",
    body:
      "Help teams organize inspections, quality records, certifications, compliance documentation and exception workflows with clear evidence and appropriate human review.",
  },
  {
    num: "04",
    title: "Demand & Supply Planning",
    body:
      "Bring together demand signals, inventory information, production data and supply conditions to help planning teams identify exceptions and coordinate follow-up actions.",
  },
  {
    num: "05",
    title: "Inventory & Distribution",
    body:
      "Reduce repetitive information handling across warehouses, cold-chain operations, logistics and distribution while helping teams identify priorities and operational exceptions.",
  },
  {
    num: "06",
    title: "Customer & Order Operations",
    body:
      "Understand incoming orders, customer requirements and product context to route work, prepare responses and coordinate actions across commercial and operational teams.",
  },
];
...
const environments = [
  {
    ...
    text:
      "Connect information across field operations, crop planning, suppliers, equipment, quality and production activities so teams can respond to operational issues with better context.",
  },
  {
    title: "Food Manufacturing",
    text:
      "Support production environments where recipes, raw materials, quality records, production schedules, inventory and compliance information need to move together.",
  },
  {
    title: "Food Supply Chain",
    text:
      "Help coordinate information across growers, suppliers, procurement, warehouses, logistics, distribution and retail channels without creating another disconnected technology layer.",
  },
  {
    title: "Corporate Functions",
    text:
      "Extend intelligent workflows into finance, HR, reporting, compliance, procurement and internal knowledge processes supporting agriculture and food organizations.",
  },
];
...
const governance = [
  [
    ...
    "Define which workflows AI can execute, which actions require approval and which agricultural, production or commercial decisions must remain with authorized teams.",
  ],
  [
    "02",
    "Data & Access",
    "Control how farm, supplier, production, quality, commercial and customer information is accessed and used across AI-assisted workflows.",
  ],
  [
    "03",
    "Evidence & Traceability",
    "Keep workflow outputs connected to source records, inspections, certifications and business information so teams can understand the evidence behind AI-assisted actions.",
  ],
  [
    "04",
    "Human Approval",
    "Keep qualified agricultural, procurement, quality, production and management teams involved wherever judgment, authorization or exception handling is required.",
  ],
];
...
const implementation = [
  {
    ...
    text:
      "Identify processes where teams spend significant time collecting field information, checking documents, coordinating suppliers, monitoring inventory or responding to operational exceptions.",
  ...
  },
  {
    ...
    text:
      "Map the people, systems, information, agricultural or food-safety rules and approval points involved in the selected process before defining the AI workflow.",
  ...
  },
  {
    ...
    text:
      "Deploy one focused workflow with clear boundaries, measurable outcomes and human review points before expanding the solution across farms, facilities or business functions.",
    left: "Defined scope",
  ...
  },
  {
    ...
    text:
      "Extend successful workflows across additional farms, facilities, suppliers, products, warehouses or business functions once value and governance are established.",
    left: "More workflows",
...
const impact = [
  [
    ...
    "Help teams gather relevant field, production and supply-chain information and move operational issues forward with less manual coordination.",
  ],
  [
    "Lower administrative effort",
    "Reduce repetitive information-handling activities across procurement, quality, planning, compliance and commercial operations.",
  ],
  [
    "Better supply chain visibility",
    "Bring information together across growers, suppliers, inventory, production, logistics and distribution workflows.",
  ],
  [
    "More consistent processes",
    "Apply defined business rules and workflow requirements across recurring agricultural, food production and supply-chain activities.",
  ],
  [
    "Improved exception handling",
    "Help teams identify missing information, quality issues, supply exceptions and cases that require attention.",
  ],
  [
    "More capacity for higher-value work",
    "Give agricultural, production and commercial teams more time to focus on planning, improvement, suppliers, customers and strategic decisions.",
  ],
];

const faqs = [
  {
    q: "What is Agentic AI in agriculture and food?",
    a:
      "Agentic AI refers to AI systems that can understand a defined objective, work with relevant business information, perform multiple workflow steps and involve people when judgment or approval is required. In agriculture and food, this can support field operations, procurement, quality, planning, compliance, production, reporting and customer workflows.",
  },
  {
    q: "Can Agentic AI work with existing agriculture and food systems?",
    a:
      "Yes. Agentic AI can be designed to work across existing ERP, farm-management, production, warehouse, procurement, quality, CRM, reporting, document-management and other enterprise systems rather than requiring organizations to replace their existing technology.",
  },
  {
    q: "Can AI automatically make agricultural or production decisions?",
    a:
      "AI can support information gathering, monitoring, workflow coordination and operational preparation, but important agricultural, food-safety, production and commercial decisions should remain subject to appropriate controls, authorization and human oversight.",
  },
  {
    q: "How can AI help agriculture and food supply chains?",
    a:
      "AI can help coordinate information across growers, suppliers, procurement, production, inventory, logistics, distribution and customer operations. It can identify exceptions, prepare information and route tasks while keeping important decisions with responsible teams.",
  },
  {
    q: "Can Agentic AI support food quality and compliance?",
    a:
      "Yes. AI can help organize quality documentation, inspection records, certifications, compliance information, non-conformance cases and corrective-action workflows. Outputs can remain connected to source evidence and routed to qualified teams for review.",
  },
  {
    q: "Do we need to automate an entire agricultural or food operation?",
    a:
...
export default function AgricultureFoodPage() {
  ...
  return (
    <main className="bg-white text-brand-primary selection:bg-brand-secondary/20">
      ...
      <section
        aria-label="Agriculture and Food AI"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-8">
              ...
              <div className="p-6 rounded-xl bg-white border border-brand-primary/10 shadow-sm relative overflow-hidden">
                ...
                <p className="text-sm text-brand-primary/70 leading-relaxed">
                  Fragmented field, supplier, production and supply-chain
                  information creates manual coordination and slows
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-base sm:text-lg font-semibold leading-relaxed text-brand-primary">
                Modern agriculture and food organizations operate across
                farms, growers, suppliers, production facilities, warehouses,
                quality teams, distributors and commercial operations.
              </p>
              ...
              <p className="mt-4 text-sm text-brand-primary/65 leading-relaxed">
                Agricultural teams manage field activities and supply
                conditions. Procurement teams coordinate suppliers. Quality
                teams investigate records and certifications. Production teams
                manage schedules and raw materials. Distribution teams
              ...
              <div className="mt-8 border-l-2 border-brand-secondary/50 pl-5">
                <p className="text-xl sm:text-2xl font-bold leading-relaxed text-brand-primary">
                  ...
                  <br />
                  More time improving the operation.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-8 self-start">
              ...
              <p className="mt-5 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Agriculture and food organizations depend on connected
                processes from field and sourcing through production,
            ...
            <div className="lg:col-span-8">
              ...
              <div className="divide-y divide-brand-primary/10 border-y border-brand-primary/10">
                {[
                  [
                    "01",
                    "Grow",
                    "Field operations, crop planning and agricultural activities",
                  ],
                  [
                    "02",
                    "Source",
                    "Growers, suppliers, procurement and raw materials",
                  ],
                  [
                    "03",
                    "Produce",
                    "Food production, quality and operational records",
                  ],
                  [
                    "04",
                    "Move",
                    "Inventory, warehouses, logistics and distribution",
                  ],
                  [
                    "05",
                    "Sell",
                    "Customers, orders and commercial operations",
                  ],
                ].map(([num, title, text]) => (
                  <div
                    key={num}
              ...
              <div className="mt-8">
                <p className="text-base sm:text-lg font-bold leading-relaxed">
                  Connected agriculture requires more than connected systems.
                  <br />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-5">
              <p className="text-sm text-white/55 leading-relaxed">
                Agriculture and food workflows often involve multiple systems,
                teams, suppliers and operational decisions. Agentic AI can
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {workflows.map((item) => (
              ...
              >
                <span className="text-[11px] font-bold tracking-[0.18em] text-[#a095ff] font-mono">
                  {item.num}
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
            ...
            {[
              [
                "01",
                "Understand",
                "Identify the operational objective, relevant context, available information and agricultural or business rules.",
              ],
              [
                "02",
                "Coordinate",
                "Retrieve information, perform defined tasks and move the workflow across connected systems and teams.",
              ],
              [
                "03",
                "Validate",
              ...
              [
                "04",
                "Escalate",
                "Bring the right team into the process when judgment, approval or exception handling is required.",
              ],
            ].map(([num, title, text]) => (
          ...
          <div className="mt-16 pt-8 border-t border-brand-primary/10">
            <p className="text-base sm:text-lg font-bold leading-relaxed text-brand-primary">
              ...
              <span className="block sm:inline text-brand-primary/45 font-normal mt-1 sm:mt-0">
                Agricultural and food teams remain in control of the decisions
                that matter.
              </span>
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="mt-5 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Agentic AI should not require agriculture or food companies
                to abandon the systems they already depend on.
              </p>

              <p className="mt-4 text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                Instead, it can operate as an intelligent layer across ERP,
                farm-management, production, procurement, quality, warehouse,
                CRM, reporting and document environments.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-8 rounded-xl bg-[#12103c] p-7 sm:p-8">
                ...
                <p className="mt-5 text-sm text-white/50 leading-relaxed">
                  ...
                  when workflows can affect food quality, production,
                  suppliers, customers or compliance.
                </p>
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-sm sm:text-base text-brand-primary/65 leading-relaxed max-w-2xl">
                ...
                automation supports operations without removing accountability.
              </p>
              ...
              <p className="mt-8 text-lg sm:text-xl font-bold tracking-tight">
                AI should make operations faster
                <span className="text-brand-primary/45">
                  {" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm sm:text-base text-brand-primary/65 leading-relaxed">
                ...
                transformation. Start with one operational workflow, prove
          ...
          <div className="mt-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-t border-brand-primary/10 pt-7">
            ...
            <p className="text-sm text-brand-primary/50 max-w-md leading-relaxed">
              ...
              farms, facilities, suppliers and business functions.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-sm sm:text-base text-white/55 leading-relaxed">
                ...
                content an AI system can produce. For agriculture and food
                organizations, the meaningful question is how much operational
                work can move forward with less manual effort.
              </p>
            ...
            <div className="lg:col-span-5">
              ...
              <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm p-6 sm:p-7">
                ...
                <h3 className="mt-4 text-xl sm:text-2xl font-bold text-brand-primary tracking-tight leading-tight">
                  Ready to put governed agents into your agriculture and food operations?
                </h3>

                <p className="mt-3 text-sm text-brand-primary/60 leading-relaxed">
                  Tell us how your teams manage field operations, procurement,
                  production, quality, supply chain or customer operations.
                  We will identify where Agentic AI can reduce friction while
                  keeping responsible teams in control of important decisions.
                </p>
