    ...
    <section className="bg-slate-50 py-20 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs font-black uppercase tracking-widest text-indigo-600">Why AgenticSense</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {whyPoints.map((p) => (
            <div key={p.title} className="bg-white rounded-xl p-6 border border-slate-200 hover:border-indigo-200 transition-colors">
