...
const caseStudies = [
  {
    ...
    challenge: "Finance teams manually entered thousands of vendor invoices each month and matched them against purchase orders and goods receipts, creating delays and increasing the risk of errors.",
    built: "We implemented an AP automation agent that captures invoices from email and uploads, performs automated three-way matching, posts approved invoices directly into SAP Business One, and routes only genuine exceptions for review.",
    resultMetric: "84%",
    resultLabel: "Straight-Through Processing Rate",
    resultDetail: "Invoice processing time was reduced from five days to less than two hours.",
  },
  {
    tag: "FINANCE REPORTING",
    code: "SYS_REP_DATA_02",
    org: "Investment & Asset Management Firm",
    challenge: "Executives relied on analysts to extract and reconcile data from Oracle Fusion before gaining visibility into business performance, slowing decision-making.",
    built: "We deployed a finance copilot integrated with Oracle Fusion that answers reporting questions in natural language, enforces role-based access controls, and highlights key variances automatically.",
    resultMetric: "16 HRS",
    resultLabel: "Saved per Week",
    resultDetail: "Reporting requests that previously took days are now completed in seconds.",
  },
  {
    tag: "OPERATIONS AUTOMATION",
    code: "SYS_OPS_FLOW_03",
    org: "Large Enterprise Services Organization",
    challenge: "Approvals, document processing, and operational workflows were spread across email and disconnected systems, creating bottlenecks and slowing execution.",
    built: "We implemented end-to-end agentic workflows that automate approvals, process documents, and update core business systems with complete visibility and auditability.",
    resultMetric: "90%",
    resultLabel: "Faster Process Completion",
    resultDetail: "Manual handoffs and repetitive approval tasks were virtually eliminated.",
  },
];
