    ...
    <section className="bg-white py-14 sm:py-14 sm:py-12 sm:py-10 sm:py-14 md:py-16 md:py-20 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-indigo-600">What Clients Say</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-slate-50 rounded-2xl border border-slate-200 p-8">
              ...
              <p className="text-base sm:text-lg text-slate-700 font-medium leading-[1.65] mb-6 italic">
                {t.quote}
              </p>
              <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center">
                  <span className="text-indigo-600 font-bold text-xs">{t.author.charAt(0)}</span>
                </div>
                <div>
