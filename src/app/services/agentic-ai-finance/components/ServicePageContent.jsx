...
export default function AgenticAiFinanceContent() {
  ...
  return (
    <main>
      ...
      {/* ── Hero (Clean Premium Color Theme - No Particles/Canvas) ──────────── */}
      <section className="relative w-full min-h-[75vh] bg-[#1a194d] overflow-hidden flex items-center font-sans pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20">
        ...
        {/* Subtle Radial Mesh Ambient Highlights */}
        <div 
          aria-hidden="true"
          className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_80%_20%,rgba(98,94,255,0.15),transparent_50%)]"
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full">
          ...
          <p className="text-base sm:text-lg leading-[1.65] tracking-[-0.005em] text-white/70 max-w-2xl mb-10">
            {hero.sub}
          </p>
