      ...
      <section className="relative bg-gradient-to-br from-slate-50 via-white to-indigo-50/40 pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-xs font-black text-indigo-400 tracking-widest uppercase">01</span>
            <span className="w-4 h-px bg-indigo-300" />
            <span className="text-xs font-bold text-slate-500 tracking-wide uppercase">Flagship Practice · Office of Finance</span>
          </div>
