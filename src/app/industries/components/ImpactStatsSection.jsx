        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#625eff]/20 border border-[#625eff]/25 rounded-none overflow-hidden">
          {stats.map((s, idx) => (
            ...
            >
              ...
              <div className="text-4xl sm:text-5xl font-mono font-bold text-white mb-3 tracking-tight group-hover:text-[#625eff] transition-colors duration-200 tabular-nums">
                {s.val}
              </div>
