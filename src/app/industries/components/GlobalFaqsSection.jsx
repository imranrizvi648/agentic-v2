  ...
  return (
    <section className="bg-[#111118] py-14 sm:py-20 md:py-14 sm:py-20 md:py-24 border-b border-white/[0.06]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight mb-12 max-w-xl">
            ...
            <details key={f.q} className="group py-5">
              <summary className="flex items-start justify-between gap-4 cursor-pointer list-none">
                <div className="flex gap-3 items-start">
                  <span className="flex-shrink-0 w-5 h-5 rounded bg-amber-400/10 border border-amber-400/20 flex items-center justify-center text-[9px] font-bold text-amber-400 mt-0.5">
                    Q
                  </span>
              ...
              <p className="pl-8 pt-3 text-sm text-white/50 leading-[1.6]">{f.a}</p>
            </details>
          ))}
        </div>
      </div>
