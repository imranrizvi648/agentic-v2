  ...
  return (
    <section style={{
      ...
      <div aria-hidden style={{
        ...
        background: "radial-gradient(circle, rgba(98,94,255,0.08) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      <div aria-hidden style={{
        position: "absolute", bottom: -100, left: -80,
        width: 380, height: 380, borderRadius: "50%",
        background: "radial-gradient(circle, rgba(26,25,77,0.05) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 32px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 72 }}>
          <span style={{
            ...
            textTransform: "uppercase", color: "#625eff", marginBottom: 20,
          }}>
            <Sparkles size={11} />
            Contact Us
          </span>
          <h1 style={{
            ...
            lineHeight: 1.1, color: "#1a194d", margin: "0 0 16px",
          }}>
            Get in touch with us
          </h1>
          <p style={{ fontSize: "1rem", color: "#6b7280", maxWidth: 420, margin: "0 auto", lineHeight: 1.65 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 20,
            padding: "40px 36px",
            boxShadow: "0 4px 32px rgba(26,25,77,0.07), 0 1px 4px rgba(26,25,77,0.04)",
          }}>
            <h2 style={{ fontSize: "1.05rem", fontWeight: 700, color: "#1a194d", margin: "0 0 28px" }}>
              Send us a message
            </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div>
                <label style={{ display: "block", fontSize: "0.68rem", fontWeight: 700,
                  letterSpacing: "0.14em", textTransform: "uppercase", color: "#9ca3af", marginBottom: 8 }}>
                  Full Name
                </label>
                <input
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginTop: -4 }}>
                <input
                  ...
                  style={{ marginTop: 2, accentColor: "#625eff", width: 15, height: 15, cursor: "pointer", flexShrink: 0 }}
                />
                <label htmlFor="agree" style={{ fontSize: "0.78rem", color: "#9ca3af", lineHeight: 1.5, cursor: "pointer" }}>
                  I agree with the{" "}
                  <a href="#" style={{ color: "#625eff", textDecoration: "underline" }}>Terms and Conditions</a>
                </label>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: submitted
                    ...
                    : "linear-gradient(135deg,#1a194d,#2d2b7a)",
                  color: "#fff",
            ...
            {/* Contact chips */}
            <div style={{ marginTop: 28, paddingTop: 24, borderTop: "1px solid #f0effe" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                {[
                  ...
                  { icon: <Phone size={13} />, label: "+92 300 0000000",       href: "tel:+923000000000" },
                ].map(({ icon, label, href }) => (
                  <a key={href} href={href} style={{
                    display: "inline-flex", alignItems: "center", gap: 7,
                    fontSize: "0.75rem", color: "#4b5563",
                    background: "#f8f8fc", border: "1px solid #eeecfc",
                    padding: "7px 14px", borderRadius: 9999,
                    textDecoration: "none", transition: "all 0.2s",
                    fontWeight: 500,
                  }}>
                    <span style={{ color: "#625eff" }}>{icon}</span>
                    {label}
                  </a>
                ))}
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
            ...
            {/* Why us */}
            <div style={{
              background: "linear-gradient(135deg,#1a194d 0%,#2d2b7a 100%)",
              borderRadius: 0, padding: "36px 32px",
              boxShadow: "0 8px 32px rgba(26,25,77,0.18)",
            }}>
              <p style={{ fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.2em",
                textTransform: "uppercase", color: "rgba(98,94,255,0.8)", marginBottom: 10 }}>
                Why partner with us
              </p>
                ...
                {FEATURES.map((text, i) => (
                  <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    <span style={{
                      ...
                      background: "rgba(98,94,255,0.25)", border: "1px solid rgba(98,94,255,0.4)",
                      marginTop: 1,
                    }}>
              ...
              {[
                {
                  country: "USA",
                  flag: "🇺🇸",
                  address: "280 W 17th St, 4th Floor\nNew York, NY 10011",
                },
                {
                  country: "Pakistan",
                  flag: "🇵🇰",
                  address: "Plot 8-2-601, University Rd\nKarachi, 500034",
                },
              ].map(({ country, flag, address }) => (
                <div key={country} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                    ...
                    <span style={{ fontSize: "0.8rem", fontWeight: 700, color: "#1a194d" }}>{country}</span>
                  </div>
            ...
            <div style={{
              ...
              <div>
                <p style={{ fontSize: "0.78rem", fontWeight: 700, color: "#15803d", margin: 0 }}>
                  Average response time: under 2 hours
                </p>
                <p style={{ fontSize: "0.68rem", color: "#4ade80", margin: "2px 0 0" }}>
                  Our team is online Mon – Fri, 9am – 6pm PKT
                </p>
              </div>
            </div>
      ...
      <style>{`
        input::placeholder, textarea::placeholder { color: #c4c2d4; }
        input:focus, textarea:focus { outline: none; }
        button[type="submit"]:hover {
          transform: translateY(-1px);
          box-shadow: 0 12px 32px rgba(26,25,77,0.28) !important;
        }
        a[href]:hover { opacity: 0.82; }
      `}</style>
    </section>
  );
}