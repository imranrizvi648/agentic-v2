      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-end justify-between mb-12 border-b border-slate-900/10 pb-8">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-black text-[#1a194d] tracking-tight leading-none">
              The Blog
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 pb-16">
            ...
            >
              ...
              <div className="relative p-8">
                ...
                <h2 className="text-2xl md:text-3xl font-black text-white leading-tight mb-3 group-hover:text-[#625eff]/90 transition-colors">
                  {primary.title}
                </h2>
              ...
              {secondary && (
                ...
                >
                  ...
                  <div className="relative p-6">
                    ...
                    <h2 className="text-lg font-black text-white leading-snug mb-2 group-hover:text-[#625eff]/90 transition-colors">
                      {secondary.title}
                    </h2>
