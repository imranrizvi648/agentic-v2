...
const slides = [
  { id: 1, title: "Reimagine your\nbusiness with AI.", description: "AgenticSense helps businesses connect AI to real workflows and develop intelligent solutions that learn, adapt, and scale.", image: "/bg-1.webp", textColor: "text-white", buttonStyle: "bg-[#625eff] text-white hover:bg-[#5a52e0] shadow-[0_4px_20px_rgba(98,94,255,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] rounded-none", hasGuideCard: true, buttonText: "Explore AI Services" },
  { id: 2, title: "AI Agents That\nPower Smarter Business Automation.", description: "AgenticSense helps businesses automate workflows, improve decision-making and scale operations with intelligent AI agent solutions.", image: "/bg2.webp", textColor: "text-white", buttonStyle: "bg-[#625eff] text-white hover:bg-[#5a52e0] shadow-[0_4px_20px_rgba(98,94,255,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] rounded-none", hasWebinarCard: true, buttonText: "Book a Free Consultation" },
  { id: 3, title: "Proven Results\nWith Real AI Impact.", description: "AgenticSense partnered with leading enterprises to achieve tenfold scalability, faster insights, and $120K in savings through optimized AI architecture.", image: "/bg-3.webp", textColor: "text-white", buttonStyle: "bg-[#625eff] text-white hover:bg-[#5a52e0] shadow-[0_4px_20px_rgba(98,94,255,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] rounded-none", hasGlassCards: true, buttonText: "See Our Work in AI" },
];
      ...
      <div className="absolute inset-0 z-0">
        <AnimatePresence mode="sync">
          <motion.div key={`bg-${current}`} variants={bgVariants} initial="initial" animate="animate" exit="exit" className="absolute inset-0" style={{ willChange: "opacity" }}>
            <img src={slides[current].image} alt="" aria-hidden="true" className="w-full h-full object-cover" loading="eager" fetchPriority="high" decoding="async" />
            ...
            <div className="relative w-full" style={{ minHeight: 300 }}>
              <AnimatePresence mode="sync">
                <motion.div key={`left-${current}`} variants={leftVariants} initial="initial" animate="animate" exit="exit" className="absolute inset-0 flex flex-col justify-center" style={{ willChange: "opacity, transform" }}>
                  <h1 className={`text-[30px] sm:text-[40px] md:text-[46px] lg:text-[50px] font-black leading-[1.08] tracking-[-1.5px] whitespace-pre-line mb-4 sm:mb-6 ${slides[current].textColor}`}>
                    {slides[current].title}
                  </h1>
                  <p className={`text-[15px] sm:text-[17px] md:text-[18px] leading-relaxed max-w-xl mb-6 sm:mb-8 ${isDarkSlide ? "text-white/75" : "text-slate-600"}`}>
                    {slides[current].description}
                  </p>
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                    className={`w-full max-w-[220px] sm:max-w-[260px] inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 font-semibold text-sm sm:text-base transition-all duration-300 ${slides[current].buttonStyle}`}>
                    ...
                    <div className="relative overflow-hidden rounded-2xl backdrop-blur-3xl bg-[#0c0a1c]/65 border border-white/[0.15] shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_12px_40px_rgba(0,0,0,0.6),0_4px_20px_rgba(98,94,255,0.15)]">
                      ...
                      <div className="p-5">
                        <div className="inline-flex items-center gap-1.5 mb-3 px-2.5 py-1 rounded-full bg-[#625eff]/20 border border-[#625eff]/30 text-[#b4abff] text-[9px] font-bold tracking-widest uppercase">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#625eff] shadow-[0_0_5px_rgba(98,94,255,0.9)]" />Free Resource
                        </div>
                        <h3 className="text-[18px] font-bold text-white mb-2 leading-snug drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">C-Suite Guide to AI in 2026</h3>
                        <p className="text-white/70 text-[12px] leading-relaxed mb-4">Strategic insights for leaders implementing AI at enterprise scale.</p>
                        <div className="h-[1px] bg-gradient-to-r from-[#625eff]/40 via-white/10 to-transparent mb-4" />
                        <a href="#" className="group/btn inline-flex items-center gap-2 text-white font-semibold text-[13px] hover:text-[#a095ff] transition-colors duration-200">
                          Download Whitepaper <ArrowRight size={14} className="group-hover/btn:translate-x-1 transition-transform duration-200" />
                        </a>
                      </div>
                    </div>
                  )}
                  ...
                  {slides[current].hasWebinarCard && (
                    <div className="relative overflow-hidden rounded-2xl backdrop-blur-3xl bg-[#0c0a1c]/65 border border-white/[0.15] shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_12px_40px_rgba(0,0,0,0.6),0_4px_20px_rgba(98,94,255,0.15)]">
                      ...
                      <div className="relative flex items-center gap-4 px-5 pt-5 pb-4 border-b border-white/[0.08]">
                        ...
                        <div className="relative z-10 ml-auto flex items-center gap-1.5 px-2 py-1 rounded-full bg-red-500/20 border border-red-400/30 flex-shrink-0">
                      ...
                      <div className="p-5">
                        <div className="inline-flex items-center gap-1.5 mb-3 px-2.5 py-1 rounded-full bg-[#625eff]/20 border border-[#625eff]/30 text-[#b4abff] text-[9px] font-bold tracking-widest uppercase">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#625eff] shadow-[0_0_5px_rgba(98,94,255,0.9)]" />Upcoming Session
                        </div>
                        <h3 className="text-[18px] font-bold text-white mb-2 leading-snug drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">How Agentic AI is Changing Business Workflows</h3>
                        <div className="flex items-center gap-4 mb-4">
                          <div className="flex items-center gap-1.5 text-white/60 text-[11px]"><Calendar size={11} /><span>June 2026</span></div>
                          <div className="flex items-center gap-1.5 text-white/60 text-[11px]"><Users size={11} /><span>Free to attend</span></div>
                        </div>
                        <div className="h-[1px] bg-gradient-to-r from-[#625eff]/40 via-white/10 to-transparent mb-4" />
                        <button className="group/btn inline-flex items-center gap-2 text-white font-semibold text-[13px] hover:text-[#a095ff] transition-colors duration-200">
                          Register Free <ArrowRight size={14} className="group-hover/btn:translate-x-1 transition-transform duration-200" />
                        </button>
                      </div>
                    </div>
                  )}
