...
const cases = [
  { id: 1, title: "Streamlined ABB's operations with Salesforce and Azure integration", tags: ["Machinery Manufacturing", "Salesforce Implementation"], logo: "ABB", quote: "tkxel shared our vision right from the get go, and helped us achieve the unthinkable.", author: "Pam Chitwood", role: "Product Manager, ABB", image: "https://i.pravatar.cc/150?u=1", caseImage: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=600" },
  { id: 2, title: "23% increase in sales team productivity with a customized CSR system", tags: ["Manufacturing", "Engineering"], logo: "knowles", quote: "WATCH TESTIMONIAL", author: "Nick Drogo", role: "Global Director IT, Knowles", image: "https://i.pravatar.cc/150?u=2", caseImage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=600", isVideo: true },
  { id: 3, title: "Drives 5X Revenue Growth Through Seamless Digital Transformation", tags: ["Food & Beverages", "Digital Transformation"], logo: "LEADING CHAIN", quote: "tkxel modernized our industry, unified ordering, and reduced manual work.", author: "Sarah Jenkins", role: "Director of Technology", image: "https://i.pravatar.cc/150?u=3", caseImage: "https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=600" },
];
    ...
    <section className="pt-16 sm:pt-20 md:pt-24 bg-white overflow-hidden font-sans">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 sm:mb-12 gap-4 sm:gap-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1a194d] tracking-tight">Featured success stories.</h2>
            ...
            <article key={item.id}
              ...
              <div className="w-full sm:w-[340px] md:w-[380px] flex-shrink-0 flex flex-col h-full relative z-10">
                <div className="mb-8 sm:mb-10">
                  <h3 className="text-xl sm:text-2xl md:text-[28px] font-semibold text-[#1a194d] leading-[1.3] mb-4 sm:mb-6">{item.title}</h3>
