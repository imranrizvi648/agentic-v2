...
export default function RealEstateContent() {
  ...
  return (
    <main className="bg-white text-foreground min-h-screen selection:bg-brand-secondary/20">
      ...
      {/* ── Hero ─────────────────────────────────────────────── */}
      <section className="relative pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 overflow-hidden border-b border-brand-primary/10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-brand-primary leading-[1.1] tracking-tight max-w-4xl mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            ...
            <Link href="#" className="inline-flex items-center justify-center gap-2 bg-brand-primary/5 font-bold text-sm px-4 sm:px-6 py-3.5 rounded-md border border-brand-primary/10 hover:bg-brand-primary/10 transition-all">
              {hero.cta2}
            </Link>
          </div>
